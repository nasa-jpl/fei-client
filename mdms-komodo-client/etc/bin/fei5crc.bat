...
rem # ==================================================================== ###
rem                                                                          #
rem  The File Exchange Interface (FEI) File CRC Client Utility               #
rem                                                                          #
rem  Function:                                                               #
rem  Compute and output the checksum value of a local file                   #
rem                                                                          #
rem                                                                          #
rem                                                                          #
rem                                                                          #
...
set LJVMARGS=%LJVMARGS% -Dmdms.user.operation=komodo.util.crc
