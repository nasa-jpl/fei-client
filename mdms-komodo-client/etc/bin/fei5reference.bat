...
rem # ==================================================================== ###
rem                                                                          #
rem  The File Exchange Interface (FEI) VFT Reference Client Utility          #
rem                                                                          #
rem  Function:                                                               #
rem  Sets a VFT reference and updates it.  NOTE: The $FEI5 environment       #
...
set LJVMARGS=%LJVMARGS% -Dmdms.user.operation=komodo.util.reference
