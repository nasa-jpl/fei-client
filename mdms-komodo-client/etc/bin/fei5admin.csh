...
#  The $FEI5 environment variable must point to the directory containing   #
#  the domain.fei and SSL keystore files.                                  #
#                                                                          #
...
#  Added xercesImpl.jar and xmlParserAPIs.jar to the classpath because     #
...
#  parser setting to user exerces.                                         #
#                                                                          #
...
# Check to see if FEI5 is defined. Set to ops domain file if not defined.
if ( ! ${?FEI5} ) then
...
${JAVA_HOME}/bin/java -Xms32m -Xmx75m -classpath ${CLASSPATH} \
	...
	jpl.mipl.mdms.FileService.komodo.client.Administrator $*
