...
rem # ==================================================================== ###
rem                                                                          #
rem  The File Exchange Interface (FEI) Handler List Utility                  #
rem                                                                          #
rem  Function:                                                               #
rem  Displays discovered file handler plugins.  NOTE: The $FEI5 environment  #
...
rem                                                                          #
rem  Created:                                                                #
rem  May 21, 2011 by Nick Toole {Nicholas.Toole@jpl.nasa.gov}                #
rem                                                                          #
rem  Modifications:                                                          # 
rem                                                                          #
rem                                                                          #
...
set LJAVACLASS=jpl.mipl.mdms.FileService.komodo.client.handlers.HandlerUtility
...
set LJVMARGS=%LJVMARGS% -Dmdms.user.operation=komodo.util.showhandlers
