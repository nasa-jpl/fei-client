...
rem # ==================================================================== ###
rem                                                                          #
rem  The File Exchange Interface (FEI) Check User Connection Utility         #
rem                                                                          #
rem  Function:                                                               #
rem  Utility program to iterate through all the file types in each           #
rem  server group specified in the domain file and issues user connect       #
rem  request.                                                                #
rem                                                                          #
rem                                                                          #
rem                                                                          #
...
set LJVMARGS=%LJVMARGS% -Dmdms.user.operation=komodo.util.check
