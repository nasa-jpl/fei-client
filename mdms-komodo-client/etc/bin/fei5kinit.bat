...
rem # ==================================================================== ###
rem                                                                          #
rem  The File Exchange Interface (FEI) Create Credentials Client Utility     #
rem                                                                          #
rem  Function:                                                               #
rem  Creates user credentials cache for FEI.  NOTE: The $FEI5 environment    #
...
set LJVMARGS=%LJVMARGS% -Dmdms.user.operation=komodo.util.login
