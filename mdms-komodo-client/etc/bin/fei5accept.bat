...
rem # ==================================================================== ###
rem                                                                          #
rem  The File Exchange Interface (FEI) Accept Client Utility                 #
rem                                                                          #
rem  Function:                                                               #
rem  Read in list of file names from standard-in and issue the specfiied     #
rem  operation on those files.                                               #
rem                                                                          #
rem                                                                          #
rem                                                                          #
rem                                                                          #
...
set LJVMARGS=%LJVMARGS% -Dmdms.user.operation=komodo.util.accept
