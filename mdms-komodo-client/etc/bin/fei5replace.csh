...
### ==================================================================== ###
#                                                                          #
#  The File Exchange Interface (FEI) File Replacement Client Utility       #
#                                                                          #
#  Function:                                                               #
#  Replaces a file or files in a file type.  NOTE: The $FEI5 environment   #
...
${JAVA_HOME}/bin/java -Xms32m -Xmx75m -classpath ${CLASSPATH} \
   ...
   domain ${FEI5}/domain.fei action replace script_name fei5replace.csh
