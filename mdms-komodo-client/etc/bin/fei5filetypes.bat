...
rem # ==================================================================== ###
rem                                                                          #
rem  The File Exchange Interface (FEI) Show File Types Client Utility        #
rem                                                                          #
rem  Function:                                                               #
rem  Shows available file types.  File types can be queried by               #
rem  server group and/or a filetype expression.                              #
rem  Use the help command option to display usage.                           #
rem                                                                          #
rem                                                                          #
rem                                                                          #
rem                                                                          #
rem  Created:                                                                #
rem  Jan. 6, 2005 by Adrian Tinio {adrian.tinio@jpl.nasa.gov}                #
rem                                                                          #
rem  Modifications:                                                          # 
...
set LJVMARGS=%LJVMARGS% -Dmdms.user.operation=komodo.util.showtypes
