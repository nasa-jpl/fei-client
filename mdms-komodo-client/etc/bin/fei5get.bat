...
rem # ==================================================================== ###
rem                                                                          #
rem  The File Exchange Interface (FEI) Get File Client Utility               #
rem                                                                          #
rem  Function:                                                               #
rem  Gets a file or files from a file type.  NOTE: The $FEI5 environment     #
...
set LJVMARGS=%LJVMARGS% -Dmdms.user.operation=komodo.util.get
