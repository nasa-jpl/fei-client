...
#                                                                          #
#  Function:                                                               #
#  Cleans a file type, deletes all files.  NOTE: The $FEI5 environment     #
...
### ==================================================================== ###
#
# $Id: fei5makeclean.csh,v 1.8 2006/07/28 01:33:21 ntt Exp $
#
...
${JAVA_HOME}/bin/java -Xms32m -Xmx75m -classpath ${CLASSPATH} \
   ...
   domain ${FEI5}/domain.fei action makeclean script_name fei5makeclean.csh
