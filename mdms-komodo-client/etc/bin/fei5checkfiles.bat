...
rem # ==================================================================== ###
rem                                                                          #
rem  The File Exchange Interface (FEI) Compare File Client Utility           #
rem                                                                          #
rem  Function:                                                               #
rem  Compares local files against files in the server                        #
rem                                                                          #
rem                                                                          #
rem                                                                          #
rem                                                                          #
...
set LJVMARGS=%LJVMARGS% -Dmdms.user.operation=komodo.util.checkfiles
