...
### ==================================================================== ###
#                                                                          #
#  The File Exchange Interface (FEI) Get File Client Utility               #
#                                                                          #
#  Function:                                                               #
#  Gets a file or files from a file type.  NOTE: The $FEI5 environment     #
...
### ==================================================================== ###
#
# $Id: fei5get.csh,v 1.8 2006/07/28 01:33:21 ntt Exp $
#
...
${JAVA_HOME}/bin/java -Xms32m -Xmx75m -classpath ${CLASSPATH} \
   ...
   domain ${FEI5}/domain.fei action get script_name fei5get.csh
