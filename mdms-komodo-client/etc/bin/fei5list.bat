...
rem # ==================================================================== ###
rem                                                                          #
rem  The File Exchange Interface (FEI) File Listing Client Utility           #
rem                                                                          #
rem  Function:                                                               #
rem  Lists a file or files from a file type.  NOTE: The $FEI5 environment    #
...
set LJVMARGS=%LJVMARGS% -Dmdms.user.operation=komodo.util.list
