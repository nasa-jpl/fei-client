...
rem # ==================================================================== ###
rem                                                                          #
rem  The File Exchange Interface (FEI) Destroy Credentials Client Utility    #
rem                                                                          #
rem  Function:                                                               #
rem  Destroys cached FEI5 user credentials.  NOTE: The $FEI5 environment     #
...
set LJVMARGS=%LJVMARGS% -Dmdms.user.operation=komodo.util.logout
