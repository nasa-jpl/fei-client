...
### ==================================================================== ###
#                                                                          #
#  The File Exchange Interface (FEI) Create Credentials Client Utility     #
#                                                                          #
#  Function:                                                               #
#  Create user credentials for FEI5 cmds.  NOTE: The $FEI5 environment     #
...
### ==================================================================== ###
#
# $Id: fei5kinit.csh,v 1.6 2006/07/28 01:33:21 ntt Exp $
#
...
${JAVA_HOME}/bin/java -Xms32m -Xmx75m -classpath ${CLASSPATH} \
   ...
   domain ${FEI5}/domain.fei action login script_name fei5kinit.csh
