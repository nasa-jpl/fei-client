...
rem # ==================================================================== ###
rem                                                                          #
rem  The File Exchange Interface (FEI) File Deletion Client Utility          #
rem                                                                          #
rem  Function:                                                               #
rem  Unregisters files specified by an expression.  NOTE: The $FEI5          #
rem  environment variable must point to the directory containing the         #
rem  domain.fei and SSL keystore files.                                      #
rem                                                                          #
rem                                                                          #
rem                                                                          #
rem                                                                          #
rem  Created:                                                                #
rem  Oct. 21, 2004 by Nick Toole {Nicholas.Toole@jpl.nasa.gov}               #
rem                                                                          #
rem  Modifications:                                                          # 
...
set LJVMARGS=%LJVMARGS% -Dmdms.user.operation=komodo.util.unregister
