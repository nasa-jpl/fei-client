...
rem # ==================================================================== ###
rem                                                                          #
rem  The File Exchange Interface (FEI) Notify Client Utility                 #
rem                                                                          #
rem  Function:                                                               #
rem  To subscribe to an input file type for automatic delivery of new        #
rem  file availability messages                                              #
rem                                                                          #
rem                                                                          #
rem                                                                          #
rem                                                                          #
...
set LJVMARGS=%LJVMARGS% -Dmdms.user.operation=komodo.util.notify
