...
rem # ==================================================================== ###
rem                                                                          #
rem  The File Exchange Interface (FEI) File Replacement Client Utility       #
rem                                                                          #
rem  Function:                                                               #
rem  Registers a file or files in a file type.  NOTE: The $FEI5 environment  #
...
set LJVMARGS=%LJVMARGS% -Dmdms.user.operation=komodo.util.register
