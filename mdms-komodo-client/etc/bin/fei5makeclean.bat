...
rem # ==================================================================== ###
rem                                                                          #
rem  The File Exchange Interface (FEI) Make Clean Client Utility             #
rem                                                                          #
rem  Function:                                                               #
rem  Cleans a file type, deletes all files.  NOTE: The $FEI5 environment     #
...
set LJVMARGS=%LJVMARGS% -Dmdms.user.operation=komodo.util.makeclean
