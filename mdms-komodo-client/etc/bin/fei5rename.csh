...
### ==================================================================== ###
#                                                                          #
#  The File Exchange Interface (FEI) File Rename Client Utility            #
#                                                                          #
#  Function:                                                               #
#  Renames a file in an FEI5 file type.  NOTE: The $FEI5 environment       #
...
### ==================================================================== ###
#
# $Id: fei5rename.csh,v 1.8 2006/07/28 01:33:21 ntt Exp $
#
...
${JAVA_HOME}/bin/java -Xms32m -Xmx75m -classpath ${CLASSPATH} \
   ...
   domain ${FEI5}/domain.fei action rename script_name fei5rename.csh
