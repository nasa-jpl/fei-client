...
rem # ==================================================================== ###
rem                                                                          #
rem  The File Exchange Interface (FEI) File Comment Client Utility           #
rem                                                                          #
rem  Function:                                                               #
rem  Adds or replaces a comment on a file.  NOTE: The $FEI5 environment      #
...
set LJVMARGS=%LJVMARGS% -Dmdms.user.operation=komodo.util.comment
