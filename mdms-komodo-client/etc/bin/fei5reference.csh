...
### ==================================================================== ###
#                                                                          #
#  The File Exchange Interface (FEI) VFT Reference Client Utility          #
#                                                                          #
#  Function:                                                               #
#  Sets a VFT reference and updates it.  NOTE: The $FEI5 environment       #
...
### ==================================================================== ###
#
# $Id: fei5reference.csh,v 1.8 2006/07/28 01:33:21 ntt Exp $
#
...
${JAVA_HOME}/bin/java -Xms32m -Xmx75m -classpath ${CLASSPATH} \
   ...
   domain ${FEI5}/domain.fei action ref script_name fei5reference.csh
