...
rem # ==================================================================== ###
rem                                                                          #
rem  The File Exchange Interface (FEI) List Credentials Client Utility       #
rem                                                                          #
rem  Function:                                                               #
rem  Lists user credential cache information. NOTE: The $FEI5 environment    #
...
set LJVMARGS=%LJVMARGS% -Dmdms.user.operation=komodo.util.credlist
