...
### ==================================================================== ###
#                                                                          #
#  The File Exchange Interface (FEI) File Deletion Client Utility          #
#                                                                          #
#  Function:                                                               #
#  Deletes files specified by a file expression in an FEI file type.  Use  #
...
### ==================================================================== ###
#
# $Id: fei5delete.csh,v 1.8 2006/07/28 01:33:21 ntt Exp $
#
...
${JAVA_HOME}/bin/java -Xms32m -Xmx75m -classpath ${CLASSPATH} \
   ...
   domain ${FEI5}/domain.fei action delete script_name fei5delete.csh
