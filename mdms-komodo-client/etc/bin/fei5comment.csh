...
### ==================================================================== ###
#                                                                          #
#  The File Exchange Interface (FEI) File Addition Client Utility          #
#                                                                          #
#  Function:                                                               #
#  Adds files specified by a file expression to an FEI file type.  Use     #
#  the help command option to display usage.  NOTE: The $FEI5 environment  #
...
#                                                                          #
#  Created:                                                                #
#  Nov. 07, 2003 by Rich Pavlovsky {rich.pavlovsky@jpl.nasa.gov}           #
#                                                                          #
#  Modifications:                                                          #
...
### ==================================================================== ###
#
# $Id: fei5comment.csh,v 1.8 2006/07/28 01:33:21 ntt Exp $
#
...
${JAVA_HOME}/bin/java -Xms32m -Xmx75m -classpath ${CLASSPATH} \
   ...
   domain ${FEI5}/domain.fei action comment script_name fei5comment.csh
