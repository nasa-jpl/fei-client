...
rem # ==================================================================== ###
rem                                                                          #
rem  The File Exchange Interface (FEI) File Rename Client Utility            #
rem                                                                          #
rem  Function:                                                               #
rem  Renames a file in an FEI file type.  NOTE: The $FEI5 environment        #
...
set LJVMARGS=%LJVMARGS% -Dmdms.user.operation=komodo.util.rename
