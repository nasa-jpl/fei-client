...
import jpl.mipl.mdms.FileService.komodo.client.Constants;
...
//   }
    ...
    *
    * @throws IOException when local directory access fail
    */
   ...
   public final void batch() {
      if (!this._tokenizer.hasMoreTokens()) {
         ...
         if (modifier.equalsIgnoreCase("repeatAt")) {
            ...
            this._batchTimer = new Timer();
            long interval = ((((long)hour) * 60L * 60L) + (((long)min) * 60L)) * 1000L;
...
//         this._currentBatchFile = new BufferedReader(new FileReader(fileName));
    ...
    *
    * @throws SessionException when network
    *            communication fail
    */
