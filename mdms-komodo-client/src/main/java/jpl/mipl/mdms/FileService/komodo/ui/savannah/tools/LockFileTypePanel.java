...
public class LockFileTypePanel extends JPanel
{
    ...
    private JRadioButton lockTypeButton;
    private JRadioButton unlockTypeButton;
    ...
    protected void initComponents()
    {
        ...
        lockTypeButton   = new JRadioButton();
        unlockTypeButton = new JRadioButton();
        filetypeLabel    = new javax.swing.JLabel();
        lockModeLabel    = new javax.swing.JLabel();
        noneModeButton   = new JRadioButton();
        ownerModeButton  = new JRadioButton();
        groupModeButton  = new JRadioButton();
