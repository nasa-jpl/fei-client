...
//    }           
    ...
    protected Element getDescriptorRoot()
    {
        ...
        try {
            ...
            // Added to rememdy issue discovered by security scan (CWE-611), XXE attack
            try {
                docFactory.setFeature("http://apache.org/xml/features/disallow-doctype-decl", true);
            } catch (javax.xml.parsers.ParserConfigurationException pcEx) {
                //silence any issues that could arise from trying to disable the feature
                //since various XML parses might comply or complain, won't know til 
                //runtime and I don't want to break anything
            }
