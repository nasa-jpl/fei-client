 ...
 * @version $Id: SlidingWindowFileDatabaseToolDerbyOnly.java,v 1.2 2013/10/14 17:24:27 ntt Exp $
 *
 */
public class SlidingWindowFileDatabaseToolDerbyOnly
{
    ...
    public SlidingWindowFileDatabaseToolDerbyOnly(String databaseName, String databaseLocation) throws Exception
    {
    ...
    {
        this.database = new SlidingWindowDerbyFileDatabase();
    ...
    public static void printUsage(String operation)
    {
        ...
        String clazzname = SlidingWindowFileDatabaseToolDerbyOnly.class.getName();
    ...
    public static void main(String[] args)
    {
        if (args.length < 3)
        {
            SlidingWindowFileDatabaseToolDerbyOnly.printUsage(null);
            System.exit(1);
        }
        ...
        SlidingWindowFileDatabaseToolDerbyOnly tool = null;
        try {            
             tool = new SlidingWindowFileDatabaseToolDerbyOnly(name, location);
